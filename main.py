...
temperatura_invernalia = int(input("Ingrese la temperatura actual de Invernalia\n"))

Daenerys_dragon = bool(input("¿Daenerys trajo a sus dragones? (si/no)\n"))
...
if ejercitoTotal >= 20000 and Daenerys_dragon and dagas_Vidriagón >= vidriagon_necesario:
    print("Victoria Absoluta")

elif ejercitoTotal >= 10000 and Daenerys_dragon and (temperatura_invernalia <= TEMPERATURA_CONGELACION or deficit_armas > 0):
...
elif ejercitoTotal < 10000 and Daenerys_dragon and temperatura_invernalia > TEMPERATURA_CONGELACION:
